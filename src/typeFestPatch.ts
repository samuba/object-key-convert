...
export type SnakeCasedPropertiesDeepPatched<Value> =
  DelimiterCasedPropertiesDeepPatched<Value, "_">;

export type CamelCasedPropertiesDeepPatched<Value> =
  CamelCasedPropertiesDeepPatchedInternal<Value>;
...
> = Value extends Exclude | Function
  ...
  : {
      [K in keyof Value as DelimiterCase<
        K,
        Delimiter
      >]: DelimiterCasedPropertiesDeepPatched<Value[K], Delimiter, Exclude>;
    };

type CamelCasedPropertiesDeepPatchedInternal<
  Value,
  Exclude = never
> = Value extends Exclude | Function
  ? Value
  ...
  : {
      [K in keyof Value as CamelCase<K>]: CamelCasedPropertiesDeepPatchedInternal<
        Value[K],
        Exclude
      >;
    };
